#ifndef CONFIG_BOARD_AC6329C_DEMO_H
#define CONFIG_BOARD_AC6329C_DEMO_H

#include "board_ac6329c_demo_global_build_cfg.h"

#ifdef CONFIG_BOARD_AC6329C_DEMO
...
#define CONFIG_BT_NORMAL_HZ	            (96 * 1000000L)
